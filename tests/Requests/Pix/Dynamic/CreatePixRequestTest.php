...
use MountBit\PagueDev\Requests\Pix\Dynamic\Create as CreateRequest;
use MountBit\PagueDev\Responses\Pix\Dynamic\Create as CreateResponse;
...
class CreatePixRequestTest extends TestCase
{
    ...
    {
        $mockResponse = $this->fixture('/pix/dynamic/create/201.json');
